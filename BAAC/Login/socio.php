			...
			<div class="collapse navbar-collapse" id="navbarToggler">
	            <ul class="navbar-nav ml-auto">
	               <!--  <li class="nav-item">
	                ...
	                <li class="nav-item">
	                    <a href="Cuentas ahorros.php " class="nav-link"><i class="fa fa-handshake-o"></i> Cuenta de Ahorro</a>
	                </li>
                    <li class="nav-item">
                        <a href="prestamo.php" class="nav-link"><i class="fa fa-child"></i>  Prestamos</a>
                    </li>
                     <li class="nav-item">
                        <a href="Multas-socios.php" class="nav-link"><i class=" fa fa-balance-scale"></i>  Multas</a>
                    </li>
                    <li class="nav-item">
                        <a href="cambiarContra.php  ?>" class="nav-link"><i class=" fa fa-expeditedssl"></i>  Cambiar contraseña</a>
                    </li>
                    <!--  <li class="nav-item">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 ml-auto mr-auto text-center">
                        <h3 style="color: #800000"> " Los socios en el Banco Comunitario son confiables y responsables ". </h3> 
                        <br />
