...
<script src="js/jquery.maskedinput-1.2.2.js" type="text/javascript"></script>
 <script type="text/javascript">
   ...
   <!-- <script src="js/jquery.min.js"></script>     -->
	...
	<title>AAC-Cuentas_ahorros</title>
			...
			<div class="collapse navbar-collapse" id="navbarToggler">
	            <ul class="navbar-nav ml-auto">
	               <!--  <li class="nav-item">
	                ...
	                <li class="nav-item">
	                    <a href="socio.php" class="nav-link"><i class="fa fa-home"></i>Inicio</a>
	                </li>
                    <li class="nav-item">
                 ...
                 <div class="row">
                    <div class="col-md-6 ml-auto mr-auto text-center">
                        ...
                        <br />
                           ...
                           <!--  aqui trabajar -->
<div class="container">
  <h2 style="color:#800000">Registo de Multas</h2>
  <p style="color: #800000">Aqui encontraras informacion sobre los registros de multas  </p>
  <form method="post">
  <table class="table">
    <thead>
      <tr>
