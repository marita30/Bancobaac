...
<head>
   ...
   if(isset($_SESSION['usuario_nombre']) || isset($_SESSION['IDcargo']) || isset($_SESSION['fecha_g']) || isset($_SESSION['id'])) {
    ...
    $sql = mysqli_query($conexion, "SELECT prestamo.id_prestamo, prestamo.monto, abono.bal_inicial, prestamo.id_rfecha FROM prestamo JOIN abono ON prestamo.id_prestamo=abono.id_prestamo WHERE prestamo.estado= 'NC' and prestamo.id_socio= '$id' and abono.n_abono=(SELECT MIN(n_abono) FROM abono WHERE id_prestamo=prestamo.id_prestamo AND estado='nc')");

     $sql2 = mysqli_query($conexion, "SELECT n_abono,importe,bal_inicial,bal_posterior,fecha_abono, abono.id_prestamo FROM abono INNER JOIN prestamo WHERE abono.id_prestamo = prestamo.id_prestamo AND abono.estado='NC' and prestamo.id_socio = '$id'");
...
<body>
    ...
    <div class="wrapper">
        <div class="page-header page-header-xs" data-parallax="true" style="background-image: url('../assets/img/socio.jpg');">
            ...
            <div class="container">
             ...
             <!--   
               //Aqui trabajar -->
                  ...
                  <div class="container">
  <h3 style="color:#800000"> * Prestamos Vijentes</h3>
  <p style="color: #800000">Aqui encontraras informacion sobre los prestamos que tiene pendientes.  </p>
  <form method="post">
  <table class="table">
    <thead>
      <tr>
        <th>No de prestamos</th>
        <th>Monto</th>
...
<div class="container">
  <h3 style="color:#800000"> * Registro de pagos por prestamos</h3>
  <p style="color: #800000">Aqui encontraras informacion sobre los pagos que se han realizado en los prestamos  </p>
  <form method="post">
  <table class="table">
    <thead>
      <tr>
    ...
    <tbody>
      ...
      <tr class="table-secondary">
               ...
               <td><?php echo $fila2['n_abono']; ?></td>
              <td><?php echo $fila2['importe']; ?></td> 
              <td><?php echo $fila2['bal_inicial']; ?></td> 
              <td><?php echo $fila2['bal_posterior']; ?></td>
              <td><?php echo $fila2['fecha_abono']; ?></td>
              <td><?php echo $fila2['id_prestamo']; ?></td>
