...
<head>
 ...
 $consulta = "SELECT total_voluntario,total_obligatorio, id_rfecha FROM cuenta_ahorro WHERE id_socio = '$id' and id_rfecha = (SELECT MAX(id_rfecha) from cuenta_ahorro where id_socio = '$id') ";
...
<script src="js/jquery.maskedinput-1.2.2.js" type="text/javascript"></script>
 <script type="text/javascript">
   ...
   <!-- <script src="js/jquery.min.js"></script>     -->
	...
	<title>AAC- Cuentas de ahorros</title>
...
<body>
 ...
 <div class="container">
  <h2 style="color:#800000">Estados de cuentas</h2>
  <p style="color: #800000">Aqui encontraras informacion sobre lo que has ahorrado en las cuentas voluntaria, obligatorio y la fecha.  </p>
  <form method="post">
  <table class="table">
    <thead>
      <tr>
        <th>Total Voluntarios</th>
        <th>Total Obligatorios</th>
        <th>Fecha</th>
      </tr>
    </thead>
    <tbody>
